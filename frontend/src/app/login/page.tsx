...
export default function LoginPage() {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gradient-to-br from-purple-50 to-blue-50 dark:from-gray-900 dark:to-gray-800">
      <div className="w-full max-w-md p-8 space-y-6 bg-white dark:bg-gray-900 rounded-xl shadow-2xl">
        ...
        <div className="mt-8 text-center text-sm text-gray-600 dark:text-gray-400">
          <p>Sign in to start chatting with AI models</p>
          <p className="mt-2">GPT • Claude • Gemini</p>
        </div>
      </div>
    </div>
  );
